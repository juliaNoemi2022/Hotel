...
const registrosVencidasHab = (req, res) => {
    if(reservas.length > 0){  
        ...
        if(resultado.length > 0){
            ...
            res.status(200).json("No existen registros de habitaciones cerrados");
        }
...
module.exports = {totalRegistroHab,check_in, check_out,registrosVencidasHab, borrarRegistroHab, modiRegistroHab}